...
Then create new _Bitbucket OAuth credentials_, enter the Bitbucket OAuth consumer key in _key_ field and the Bitbucket OAuth consumer secret in _secret_ field
