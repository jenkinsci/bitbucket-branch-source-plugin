...
public class BitbucketServerAvatar implements AvatarImageSource {
    private static final Logger logger = Logger.getLogger(BitbucketServerAvatar.class.getName());
    ...
    public BitbucketServerAvatar(String serverURL, String owner, String credentialsId) {
